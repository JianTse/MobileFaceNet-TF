...
if __name__ == '__main__':
    ...
    resize_height = 112  # 指定存储图片高度
    resize_width = 112  # 指定存储图片宽度
    shuffle=True
    log=5

    '''
    # 产生train.record文件
    image_dir='E:/work/data/faceRecognize/insightface_faces_umd_ms1m_vgg_112/faces_ms1m_112x112_train/3'
    train_labels = image_dir + '/img_list.txt'  # 图片路径
    train_record_output = 'E:/work/data/faceRecognize/insightface_faces_umd_ms1m_vgg_112/faces_ms1m_112x112_train/3/train.tfrecords'
    ...
    record_file = os.path.join(rootDir, 'tran.tfrecords')
    batch_test(record_file, resize_height, resize_width)
